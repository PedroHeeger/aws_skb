...
| iam | Instance Profile | instace_profile | - | Criar/Excluir um perfil de instância do IAM | 8 | Sim | [Ver código](./iam/instace_profile.ps1) |
...
| iam | Vinculação | instace_profile_role | Instance Profile; Role | Adicionar/Remover uma role do IAM a um perfil de instância | 7 | Não | [Ver código](./iam/instace_profile_role.ps1) |
