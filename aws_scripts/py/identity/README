...
| iam | Vinculação | instace_profile_role | Instance Profile; Role | Adicionar/Remover uma role do IAM a um perfil de instância | 7 | Não | [Ver código](./iam/instance_profile_role.py) |
